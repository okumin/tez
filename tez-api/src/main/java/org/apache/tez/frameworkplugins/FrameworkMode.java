...
public enum FrameworkMode {
  ...
  STANDALONE_LOCAL(
      "org.apache.tez.frameworkplugins.local.LocalStandaloneClientFrameworkService",
      "org.apache.tez.frameworkplugins.local.LocalStandaloneServerFrameworkService");
